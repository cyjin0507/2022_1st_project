...
public class CommentSelect {
	...
	public String[] CommentIdx(String bidx) {
		// 댓글의 갯수를 임의로 1000개라고 정한다
		String[] list_bidx_ = new String[1000];
	...
	public String[] CommentBidx(String bidx_) {
		// 댓글의 갯수를 임의로 1000개라고 정한다
		...
		try {
			...
			ResultSet rs = stmt.executeQuery("select * from commentTable where bidx=" + bidx_ + " ORDER by idx desc");
	...
	// 댓글에 필요한 부분을 리턴해준다.
	public String comment(String _bidx, String keyWord) {
